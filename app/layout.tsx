...
export const metadata: Metadata = {
	title: 'Sreeram Melpadi | Portfolio',
	description:
	...
	authors: [{ name: '[Sreeram Melpadi]' }],
	creator: '[Sreeram Melpadi]',
	openGraph: {
		title: 'Sreeram Melpadi - Developer Portfolio',
		...
		url: 'https://sreerammelpadi.github.io/',
		siteName: 'Sreeram Melpadi - Developer Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: '[Sreeram Melpadi] - Modern Minimal Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
