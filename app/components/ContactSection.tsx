	...
	return (
		...
		>
			...
			<div className="relative z-10 max-w-3xl mx-auto text-center">
				...
				>
					<a
						href="mailto:melpadisreeram@gmail.com"
				...
				>
					<a
						href="https://github.com/sreerammelpadi"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/sreeram-melpadi"
						target="_blank"
						rel="noopener noreferrer"
						className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
					>
					...
					<a
						href="https://medium.com/@melpadisreeram"
						target="_blank"
						rel="noopener noreferrer"
						className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
					>
